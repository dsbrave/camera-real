...
const UserPreferencesModal: React.FC<UserPreferencesModalProps> = ({
  ...
  const [selectedModelTypes, setSelectedModelTypes] = useState<
    ("mulheres" | "homens" | "casais" | "trans" | "todos")[]
  >(["todos"]);
  ...
  const handleModelTypeToggle = (
    typeId: "mulheres" | "homens" | "casais" | "trans" | "todos",
  ) => {
