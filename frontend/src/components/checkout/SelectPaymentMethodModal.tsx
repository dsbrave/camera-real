      ...
      <div className="max-h-[90vh] overflow-y-auto p-0 md:p-6 min-h-[320px]">
        ...
        <div className="space-y-2 mb-3">
          ...
          >
            <div className="flex items-center gap-1.5">
              ...
              <div className="text-left">
                <div className="text-white font-semibold text-base">PIX</div>
          ...
          <button
            ...
            className={`w-full py-1.5 px-3 rounded-lg border text-sm font-semibold transition-all hover:scale-105 shadow-[0_0_10px_rgba(242,87,144,0.3)] border-[#F25790]/30 bg-gradient-to-r from-[#F25790]/15 to-[#d93d75]/15 hover:from-[#F25790]/20 hover:to-[#d93d75]/20 text-white mb-2 ${selectedMethod === 'credit-card' ? 'border-[#F25790] bg-gradient-to-r from-[#F25790]/30 to-[#d93d75]/30' : ''}`}
          >
            <div className="flex items-center gap-1.5">
              <div className="w-7 h-7 bg-gradient-to-br from-[#F25790]/40 to-[#d93d75]/40 rounded-lg flex items-center justify-center">
                <Image
              ...
              <div className="text-left">
                <div className="text-white font-semibold text-base">Cartão de Crédito</div>
