  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cadastre-se como modelo na Camera Real e comece a gerar renda"
        />
      </Head>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/images/high-resolution_studio_photo_of_a_confident_brazilian-inspired_model_wearing_an_elegant_black_lace__i7mo7j07sng27o0fv86l_2.png')",
      ...
      >
        ...
        <div className="relative z-10" style={{ transform: "scaleX(-1)" }}>
          ...
          <div className="py-3 md:py-6 w-full z-50">
            <div className="container mx-auto px-4 flex justify-between items-center">
              ...
              <div className="hidden lg:block">
                <Link
                  href="/"
                  className="text-[#F25790] hover:underline text-xs sm:text-sm font-medium"
                >
                  ← Voltar para home
                </Link>
              </div>
          ...
          <div className="lg:hidden absolute top-3 sm:top-4 md:top-5 right-0 p-3 sm:p-5 z-50">
            <Link
              href="/"
              className="text-[#F25790] hover:underline text-xs sm:text-sm font-medium block"
            >
              ← Voltar para home
            </Link>
          </div>
          ...
          <div className="flex flex-col lg:flex-row min-h-screen pt-0 lg:pt-0">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-start text-left p-6 sm:p-8 lg:p-12 xl:p-16 z-10 relative min-h-[50vh] lg:min-h-screen">
              <div
                className="max-w-lg ml-4 sm:ml-8 lg:ml-12 xl:ml-20"
              ...
              >
                ...
                <p className="text-base sm:text-lg mb-6 lg:mb-8 leading-relaxed">
                  Junte-se a nós e comece a gerar remuneração proporcional à sua
            ...
            <div
              className="w-full lg:w-1/2 flex items-center justify-center lg:justify-start p-4 sm:p-6 lg:p-8 xl:p-12 min-h-[50vh] lg:min-h-screen"
            ...
            >
              <div className="max-w-sm sm:max-w-md w-full lg:ml-4 xl:ml-8 bg-gradient-to-br from-black/80 via-black/70 to-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-white/20 shadow-2xl">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-[#F25790]">
                  Cadastro para modelo
                </h2>
                ...
                >
                  ...
                  <div className="mb-2 sm:mb-3">
                    <label
                      ...
                      className="block text-xs sm:text-sm font-medium mb-1 text-[#F25790]"
                    >
                      Nome completo
                    </label>
                    <input
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="feminino" className="bg-black">
                          Feminino
                        </option>
                        <option value="masculino" className="bg-black">
                          Masculino
                        </option>
                  ...
                  <div className="mb-2 sm:mb-3">
                    <label className="block text-xs sm:text-sm font-medium mb-1 text-[#F25790]">
                      Documentos
                    </label>
                    <div className="grid grid-cols-1 gap-2">
                      <div className="border border-gray-700 rounded-lg p-2 cursor-pointer hover:border-[#F25790] transition-colors">
                        ...
                        >
                          <svg
                            className="w-4 h-4 text-[#F25790] mr-2 flex-shrink-0"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
          ...
          {showSuccessModal && (
            <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
              <div className="bg-[#1A1A1A] p-6 sm:p-8 rounded-xl max-w-md w-full text-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold mb-2 break-words truncate">
                  Cadastro enviado com sucesso!
                </h3>
                <p className="text-gray-300 mb-6 text-sm sm:text-base break-words truncate">
                  Seu cadastro está em análise. Você receberá um e-mail com o
