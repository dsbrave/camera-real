  ...
  const todosModelos: Modelo[] = [
    {
      ...
      categorias: ['conversa', 'dança', 'música'],
      online: true,
      destacado: true,
      avaliacoes: 4.8,
      valorPorMinuto: 1,
    ...
    },
    {
      ...
      categorias: ['conversa', 'arte', 'filosofia'],
      online: false,
      destacado: false,
      avaliacoes: 4.7,
      valorPorMinuto: 1,
    ...
    },
    {
      id: 'm3',
      nome: 'Mia Oliveira',
      fotoPerfil: '/images/high-quality_fashion_studio_photo_of_a_fit_brazilian-inspired_model_in_a_streaming_room_setup_the_m_qhcvmpojebov1lic1cwu_0.png',
      categorias: ['conversa', 'jogos', 'tecnologia'],
      online: true,
      destacado: true,
      avaliacoes: 4.9,
      valorPorMinuto: 1,
