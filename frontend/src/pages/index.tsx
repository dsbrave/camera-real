...
export default function Home() {
  ...
  const getFilteredModels = () => {
    ...
    if (!userPreferences.modelType.includes("todos")) {
      ...
      filteredModels = filteredModels.filter((modelo) =>
        userPreferences.modelType.some(
          (selectedType) =>
  ...
  const saldoDisponivel = 1200.5;
  const ganhosHoje = 150.0;
  const ganhosMes = 3200.0;
  ...
  const notificacoes = [
    {
      tipo: "info",
      texto:
        "Nova campanha: Bônus de 10% para quem ficar mais de 2h online hoje!",
    },
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="A melhor plataforma de videochat ao vivo. Converse com modelos em tempo real."
          />
        </Head>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/high-quality_fashion_studio_photo_of_a_fit_brazilian-inspired_model_in_a_streaming_room_setup_the_m_l1g01p6hm0p1kyxw2q42_0.png')",
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Página inicial da modelo - Camera Real"
          />
        </Head>
        <div
          className="min-h-screen w-full bg-black text-white flex flex-col overflow-hidden"
          style={{
            backgroundImage,
            backgroundSize: "cover",
                        ...
                        <img
                          src={
                            JSON.parse(localStorage.getItem("user") || "{}")
                              .fotoPerfil || "/images/avatar-default.png"
                          }
                          alt="Foto de perfil"
                ...
                <div className="flex-1 lg:max-w-xl flex flex-col gap-6 mt-10 lg:mt-0">
                  ...
                  <div className="bg-gray-900/80 rounded-2xl p-6 shadow-lg mb-2">
                    ...
                    <div className="flex gap-4 items-center mb-4">
                      <div className="bg-gray-800 rounded-lg p-3 text-center text-sm text-gray-300">
                        <div className="font-bold text-lg text-[#F25790]">
                          JUL
                        </div>
                        <div className="flex gap-1 mt-2">
                          <span className="bg-[#F25790] text-white rounded px-2">
                            5
                          </span>
                          <span className="bg-gray-700 text-gray-200 rounded px-2">
                            7
                          </span>
                          <span className="bg-gray-700 text-gray-200 rounded px-2">
                            12
                      ...
                      <div className="flex-1">
                        {compromissos.map((c, i) => (
                          <div
                            key={i}
                            className="flex items-center gap-2 mb-1 text-sm text-gray-200"
                          >
                            <span className="text-[#F25790] font-semibold">
                              {c.data}
                            </span>
                            <span>{c.tipo}</span>
                    ...
                    <button className="btn-secondary px-4 py-2 text-sm mt-2">
                      Ver Agenda Completa
                    </button>
                  </div>
                  {/* Bloco Feedbacks */}
                  <div className="bg-gray-900/80 rounded-2xl p-6 shadow-lg mb-2">
                    <h2 className="text-lg font-bold mb-4 text-[#F25790] flex items-center gap-2">
                      ...
                      >
                        <path
                          d="M17 8h2a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2v-8a2 2 0 012-2h2M12 15v.01M12 11v2m0 4a9 9 0 100-18 9 9 0 000 18z"
                          stroke="#F25790"
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    <div className="flex flex-col gap-3">
                      {feedbacks.map((f, i) => (
                        <div
                          key={i}
                          className="flex items-center gap-3 bg-gray-800/60 rounded-lg p-3"
                        >
                          <img
                            src={f.foto}
                            alt={f.usuario}
                            className="w-10 h-10 rounded-full object-cover border-2 border-[#F25790]"
                          />
                          <div className="flex-1">
                            <Link
                              href={f.perfil}
                              className="text-[#F25790] font-semibold hover:underline"
                            >
                              {f.usuario}
                            </Link>
                    ...
                    <button className="btn-secondary px-4 py-2 text-sm mt-4">
                  ...
                  <div className="bg-gray-900/80 rounded-2xl p-6 shadow-lg">
                    <div className="mb-3">
                      <h3 className="text-[#F25790] font-bold mb-1">
                        Meta diária
                      </h3>
                      <p className="text-white text-base">
                        Faltam <span className="text-green-400">20 min</span>{" "}
                        para bater sua meta e ganhar bônus!
                      </p>
                    </div>
                    <div className="mb-3">
                      <h3 className="text-[#F25790] font-bold mb-1">
                      ...
                      <p className="text-gray-200 text-base">
                        Perfis com foto e descrição completa recebem até{" "}
                        <span className="text-[#F25790] font-semibold">
                          30% mais chamadas
                        </span>
                        .
                    ...
                    <div>
                      ...
                      <p className="text-gray-200 text-base">
                        ...
                        para quem ficar mais de 2h online hoje!
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {isLoggedIn ? (
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:gap-8 xl:gap-12 min-h-full">
                ...
                <div className="flex-1 lg:max-w-xl text-center lg:text-left">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 leading-tight">
                    Olá <span className="text-[#F25790]">{userName}</span>!
                    <br />
                    Seus videochats personalizados
                    <br />
                    te aguardam em{" "}
                    <span className="text-[#F25790]">tempo real</span>.
                  </h1>

                  <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-10 leading-relaxed">
                    Experiências selecionadas especialmente para você.
                    <br className="hidden sm:block" />
                  ...
                  <div className="mb-8 lg:mb-0">
                    <div className="flex flex-col sm:flex-row gap-4 items-center lg:items-start">
                      <Link
                        href="/explorar"
                        className="bg-[#F25790] hover:bg-[#d93d75] text-white font-medium py-3 sm:py-4 px-8 sm:px-10 rounded-full inline-block text-center transition-colors duration-200 text-sm sm:text-base"
                      >
                        Explorar Agora
                      </Link>
                      <Link
              ...
              <div className="flex justify-center lg:justify-start items-center min-h-full">
                <div className="w-full max-w-3xl text-center lg:text-left">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 leading-tight">
                    ...
                    <span className="text-[#F25790]">prazer</span> em tempo
                    real.
                  </h1>

                  <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                    Conheça nossa plataforma inovadora de chat por vídeo.
                    <br className="hidden sm:block" />
                    Em apenas um clique descubra um novo jeito de interagir.
                    <br className="hidden sm:block" />
