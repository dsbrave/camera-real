  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Entre na sua conta Camera Real e acesse nossa plataforma"
        />
      </Head>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/Group 26.png')",
      ...
      >
        ...
        <div className="flex justify-center items-center min-h-screen px-4 pt-20 sm:pt-0">
          ...
          <div className="w-full max-w-sm sm:max-w-md p-6 sm:p-8 bg-black/90 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-700/50 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden rounded-2xl">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(242, 87, 144, 0.3) 0%, rgba(242, 87, 144, 0.05) 40%, transparent 70%)",
                    filter: "blur(4px)",
                    transform: "translate(-50%, -50%)",
                  }}
                />
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, transparent 50%, rgba(139, 92, 246, 0.1) 60%, transparent 70%)",
                    filter: "blur(2px)",
                    transform: "translate(-50%, -50%)",
                  }}
                />
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, transparent, rgba(242, 87, 144, 0.3), transparent)",
                    transform: "translate(-50%, -50%)",
                    filter: "blur(0.5px)",
                  }}
                />
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, transparent, rgba(242, 87, 144, 0.3), transparent)",
                    transform: "translate(-50%, -50%)",
                    filter: "blur(0.5px)",
                  }}
                />
            ...
            <div className="relative z-10">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-center text-[#F25790]">
                Login
              </h2>
              ...
              <div className="mt-4 sm:mt-6 text-center text-xs text-gray-400">
                ...
                <p className="mt-1">
                  Usuário: teste@camera.real / Senha: senha123
                </p>
                <p className="mt-1">
                  Modelo: modelo@camera.real / Senha: senha123
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-gradient-to-br from-gray-900/95 via-gray-800/90 to-black/95 backdrop-blur-lg p-8 rounded-2xl max-w-md w-full border border-gray-700/50 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 mb-4">
                    Insira seu e-mail cadastrado para receber um link de
                  ...
                  <form onSubmit={handleForgotPassword} className="space-y-4">
                    <div>
                      <label
                        ...
                        className="block text-sm font-medium mb-1 text-[#F25790]"
                      >
                        E-mail
                      </label>
                      <input
              ...
              <div className="bg-gradient-to-br from-gray-900/95 via-gray-800/90 to-black/95 backdrop-blur-lg p-8 rounded-2xl max-w-md w-full text-center border border-gray-700/50 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 mb-6">
                    Enviamos instruções para recuperação de senha no seu e-mail.
        ...
        <div className="absolute bottom-0 left-0 right-0 py-4 px-5 flex justify-between items-center text-sm text-gray-400">
          ...
          <div className="flex space-x-6">
            ...
            <Link href="/suporte" className="hover:text-[#F25790]">
              Suporte
            </Link>
