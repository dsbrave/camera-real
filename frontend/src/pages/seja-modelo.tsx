...
export default function SejaModelo() {
      ...
      <div className="min-h-screen bg-black text-white" style={{ backgroundImage: "url('/images/high-quality_fashion_studio_photo_of_a_fit_brazilian-inspired_model_in_a_streaming_room_setup_the_m_6xmeh5hwdbulnwsdojt2_3.png')", backgroundSize: 'cover', backgroundPosition: 'right 5%', transform: 'scaleX(-1)' }}>
        ...
        <div className="relative z-10" style={{ transform: 'scaleX(-1)' }}>
          ...
          <div className="flex flex-col lg:flex-row min-h-screen">
            ...
            <div className="w-full flex items-start justify-start pt-2 pb-0 px-2 sm:pt-4 sm:pb-0 sm:px-4 md:pt-6 md:pb-0 md:px-6 lg:pt-8 lg:pb-0 lg:px-8 min-h-[40vh]">
  <div className="max-w-lg w-full text-left lg:ml-6 mt-0">
    ...
    <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-5 sm:mb-6 w-fit">
      <div className="bg-black/20 border border-white/5 px-2 py-2 sm:px-3 sm:py-2 rounded flex items-center gap-2 shadow-sm backdrop-blur-sm w-fit max-w-xs">
        <span className="text-[#F25790] flex items-center justify-center w-7 h-7">
          {/* Ícone dinheiro */}
        ...
        <div>
          <h3 className="font-bold text-xs sm:text-sm mb-0.5">Ganhos Altos</h3>
          <p className="text-xs text-gray-400 leading-tight">60-70% de comissão</p>
        </div>
      </div>
      <div className="bg-black/20 border border-white/5 px-2 py-2 sm:px-3 sm:py-2 rounded flex items-center gap-2 shadow-sm backdrop-blur-sm w-fit max-w-xs">
        <span className="text-[#F25790] flex items-center justify-center w-7 h-7">
        ...
        <div>
          <h3 className="font-bold text-xs sm:text-sm mb-0.5">Segurança</h3>
          <p className="text-xs text-gray-400 leading-tight">Plataforma segura</p>
        </div>
      </div>
      <div className="bg-black/20 border border-white/5 px-2 py-2 sm:px-3 sm:py-2 rounded flex items-center gap-2 shadow-sm backdrop-blur-sm w-fit max-w-xs">
        <span className="text-[#F25790] flex items-center justify-center w-7 h-7">
        ...
        <div>
          <h3 className="font-bold text-xs sm:text-sm mb-0.5">Flexibilidade</h3>
          <p className="text-xs text-gray-400 leading-tight">Horários livres</p>
        </div>
      </div>
      <div className="bg-black/20 border border-white/5 px-2 py-2 sm:px-3 sm:py-2 rounded flex items-center gap-2 shadow-sm backdrop-blur-sm w-fit max-w-xs">
        <span className="text-[#F25790] flex items-center justify-center w-7 h-7">
        ...
        <div>
          <h3 className="font-bold text-xs sm:text-sm mb-0.5">Suporte</h3>
          <p className="text-xs text-gray-400 leading-tight">Equipe dedicada</p>
        </div>
      </div>
    </div>
